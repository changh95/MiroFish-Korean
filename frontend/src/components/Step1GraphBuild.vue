    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            생성된 온톨로지를 기반으로 문서를 자동 분할한 후 Zep을 호출하여 지식 그래프를 구축하고, 엔티티와 관계를 추출하며, 시간 순서 메모리와 커뮤니티 요약을 생성합니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">그래프 구축이 완료되었습니다. 다음 단계로 이동하여 시뮬레이션 환경을 설정하세요</p>
          <button 
            class="action-btn" 
