    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            시뮬레이션 인스턴스를 생성하고 시뮬레이션 세계 매개변수 템플릿을 가져옵니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            컨텍스트를 결합하여 지식 그래프에서 엔티티와 관계를 정리하는 도구를 자동으로 호출하고, 시뮬레이션 개체를 초기화하며, 현실 시드를 기반으로 고유한 행동과 기억을 부여합니다
          </p>
      ...
      <!-- Step 03: 이중 플랫폼 시뮬레이션 설정 생성 -->
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">03</span>
            <span class="step-title">이중 플랫폼 시뮬레이션 설정 생성</span>
          </div>
          <div class="step-status">
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              ...
              <div class="time-periods">
                ...
                <div class="period-item">
                  <span class="period-label">비수기 시간대</span>
              ...
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">시의성 가중치</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            내러티브 방향을 기반으로 초기 활성화 이벤트와 핫 토픽을 자동 생성하여 시뮬레이션 세계의 초기 상태를 유도합니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">시뮬레이션 환경이 준비되었습니다. 시뮬레이션을 시작할 수 있습니다</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish가 현실 <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> 시간을 자동으로 계획하며, 각 라운드는 현실 <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> 분의 시간 경과를 나타냅니다</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>에이전트 규모가 100인 경우: 약 {{ Math.round(customMaxRounds * 0.6) }} 분 소요 예상</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        에이전트 규모가 100인 경우: 약 {{ Math.round(autoGeneratedRounds * 0.6) }} 분 소요 예상
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">처음 실행하는 경우, '사용자 정의 모드'로 전환하여 시뮬레이션 라운드 수를 줄이는 것을 강력히 권장합니다. 이를 통해 빠르게 결과를 미리 보고 오류 위험을 줄일 수 있습니다 ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">이벤트 외현 나이</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} 세</span>
            </div>
            <div class="info-item">
              <span class="info-label">이벤트 외현 성별</span>
            ...
            <div class="info-item">
              <span class="info-label">이벤트 외현 MBTI</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">이 이벤트에서의 완전한 행동 경로</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">행동 패턴 분석</span>
                <span class="dim-desc">경험 요약 및 행동 스타일 선호도</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">고유 기억 인상</span>
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('완료된 준비 작업이 감지되었습니다. 직접 사용합니다')
      ...
      if (res.data.expected_entities_count) {
        ...
        addLog(`Zep 그래프에서 ${res.data.expected_entities_count} 개의 엔티티를 읽었습니다`)
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(`✓ 총 ${currentCount} 개 에이전트 페르소나 생성 완료`)
        }
      }
    }
  } catch (err) {
...
const loadPreparedData = async () => {
  ...
  addLog(`${profiles.value.length} 개 에이전트 페르소나 로드 완료`)
