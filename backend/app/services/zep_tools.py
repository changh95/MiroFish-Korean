...
Return the list of sub-questions in JSON format."""
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer each question in order by number, starting each answer with \"Question X:\" (X is the question number)\n"
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                clean_text = re.sub(r'Question\s*\d+[：:]\s*|问题\d+[：:]\s*', '', clean_text)
...
- Bold (**keyword**) may be used to mark key terms, but avoid all other Markdown syntax"""
