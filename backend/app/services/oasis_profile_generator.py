...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """获取系统提示词"""
        base_prompt = "You are a social media user persona generation expert. Generate detailed, realistic personas for public opinion simulation, reproducing existing real-world situations as faithfully as possible. You must return valid JSON format; all string values must not contain unescaped newline characters. Use Chinese."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, reproducing existing real-world situations as faithfully as possible.
...
2. persona: Detailed persona description (2000 characters of plain text), including:
   ...
   - Personal memory (an important part of the persona — describe this individual's connection to the event, and their existing actions and reactions in it)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for an institution/group entity, reproducing existing real-world situations as faithfully as possible.
...
2. persona: Detailed account profile description (2000 characters of plain text), including:
   - Basic institution information (official name, nature of the institution, founding background, primary functions)
   ...
   - Institutional memory (an important part of the institutional persona — describe this institution's connection to the event, and its existing actions and reactions in it)
